...
@implementation GrainTableViewCell
...
-(void) textFieldDidEndEditing:(UITextField *)textField {
    self.grain.amount = textField.text.doubleValue;
    [self updateFields];
...
-(void) updateFields {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"GrainsChanged" object:nil];
